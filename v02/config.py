...
EMAIL_ACCOUNT_OUT = "email@email.com"
EMAIL_PASSWORD_OUT = "emailpass" # Используйте пароль приложения, а не основной пароль
SMTP_SERVER_OUT = "IP.IP.IP.IP"
...
# URL страницы входа
LOGIN_URL = "https://IP.IP.IP.IP:8098/bioLogin.do"

# Учетные данные для входа
USERNAME = "userweb"
PASSWORD = "passuderweb"
